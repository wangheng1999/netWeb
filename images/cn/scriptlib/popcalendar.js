...
//	email :	fuushikaden@yahoo.com
	...
	var imgDir = "../images/cn/images/"			// directory for images ... e.g. var imgDir="/img/"

//	var gotoString = "Go To Current Month"
//	var todayString = "Today is"
	var todayString = "今天是"
	var gotoString = "回到当前月"
	var weekString = "Wk"
...
//	var	monthName2 = new Array("JAN","FEB","MAR","APR","MAY","JUN","JUL","AUG","SEP","OCT","NOV","DEC")
	...
	function init()	{
		if (!ns4)
		{
			...
			if (showToday==1)
			{
				document.getElementById("lblToday").innerHTML =	todayString + " <a onmousemove='window.status=\""+gotoString+"\"' onmouseout='window.status=\"\"' title='"+gotoString+"' style='"+styleAnchor+"' href='javascript:monthSelected=monthNow;yearSelected=yearNow;constructCalendar();'>星期"+dayName[(today.getDay()-startAt==-1)?6:(today.getDay()-startAt)]+", " + dateNow + " 日 " + monthName[monthNow].substring(0,3)	+ "	" +	yearNow	+ "</a>"
			}
