        ...
        <div class="contact-us-wrapper">
            <div class="container mx-auto px-4 md:px-8 py-8 lg:py-12 bg-white">
                ...
                <div class="update_detail">
                    ...
                    <div class="update_detail_bot"><a class="prev" href="PicDetail.aspx?ID=<%=intPrevious %>">上一篇：<%=strPrevious %></a><a class="next" href="PicDetail.aspx?ID=<%=intNext %>">下一篇：<%=strNext %></a></div>
                </div>
                <!--Content End-->
            </div>
        </div>
